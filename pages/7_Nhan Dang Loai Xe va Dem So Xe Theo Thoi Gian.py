...
YOLOV3_CFG = 'vehicles_counting/yolov3-tiny.txt'
YOLOV3_WEIGHT = 'vehicles_counting/yolov3-tiny.weights'
            ...
            for idx, box in enumerate(boxes):
                ...
                if not check_location(box_y, box_height, height):
                    ...
                    if check_new_object and check_start_line(box_y, box_height):
                        ...
                        new_tracker = cv2.TrackerKCF_create()  # Sử dụng cv2.TrackerKCF_create
...
if __name__ == '__main__':
    counting_vehicle('vehicles_counting/highway.mp4', 'vehicles_counting/pedestrian.mp4')
